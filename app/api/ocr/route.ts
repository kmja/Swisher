...
- "shared": true ONLY when a line is clearly meant for the whole table to split. Strong shared cues: a wine/drink that is a whole bottle or carafe ("Flaska", "Btl", "75cl", "70cl", "0,75l", "karaff", "tillbringare", "pitcher"); a sharing platter or board ("plankstek", "plateau", "charkbricka", "ostbricka", "antipasti", "meze", "tapas", "mixed grill"); a side or starter clearly for the table ("att dela", "to share", "för bordet", "för 2", "bröd & smör", "oliver"). Individual servings are NOT shared: a beer, a glass ("glas") of wine, a coffee, a single main, or one person's dish is false even when the size is large ("stor"). When genuinely unsure, use false.
