...
const sv: Strings = {
  ...
  whyNumber: "Används för att skapa betalningslänkar som öppnar Swish direkt på gästernas telefon.",
...
const en: Strings = {
  ...
  whyNumber: "Used to create payment links that open Swish directly on your guests' phones.",
